...
invoiceRouter.put('/:id/pay', isLoggedIn, payInvoice);
invoiceRouter.post('/:id/upload-proof', isLoggedIn, upload.single('proof'), uploadProofOfPayment);
invoiceRouter.put('/:id/approve-payment', isLoggedIn, adminOnly, approvePayment);
invoiceRouter.get('/', isLoggedIn, getInvoices);
invoiceRouter.get('/:id', isLoggedIn, getInvoiceById);
