...
auditRouter.put('/:id/respond', isLoggedIn, resolveCompanyUser, respondToAudit);
...
auditRouter.post('/:id/nc-correction', isLoggedIn, resolveCompanyUser, upload.array('correctionFile', 10), uploadNcCorrection);
auditRouter.post('/:id/nc-remind', isLoggedIn, adminOnly, remindNcCorrection);
auditRouter.get('/', isLoggedIn, resolveCompanyUser, getAudits);
