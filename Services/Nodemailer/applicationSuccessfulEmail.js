...
/**
 * Sends an email to the client when their Halal Certification application is successful.
 *
 ...
 */
const applicationSuccessfulEmail = async (email, clientName, applicationId) => {
  try {
    console.log("📤 Sending Application Successful email to:", email);
    ...
    const data = await transporter.sendMail({
      ...
      to: email,
      subject: `🎉 Halal Certification Application Successful — Application ${applicationId}`,
      html: `
        <div style="font-family: Arial, sans-serif; font-size: 16px; color: #333; line-height: 1.6; padding: 20px; background-color: #f9fafb;">
          <div style="max-width: 600px; margin: auto; background: #ffffff; border: 1px solid #e0e0e0; border-radius: 10px; padding: 30px;">
            ...
            <p>
              We are pleased to congratulate you on the successful completion of your Halal Certification process.
            </p>

            <p>
              Your application <strong>${applicationId}</strong> has been approved, and your products have successfully met the requirements for Halal Certification.
            </p>

            <div style="background-color: #f0fdf4; border-left: 4px solid #00853b; padding: 16px; margin: 24px 0; border-radius: 4px;">
              <p style="margin: 0; font-weight: bold; color: #166534; font-size: 17px;">Next Step:</p>
              <p style="margin: 6px 0 0 0; color: #15803d;">
                Your Halal Certificate is now being processed and will be issued shortly.
              </p>
            </div>

            <p>
              You can track the progress of your application and view updates by logging into your HDI Portal dashboard.
            </p>
            ...
            <p style="margin-top: 24px;">
              Congratulations once again, and thank you for choosing the Halal & Haram Distinction Development Initiative (HDI).
            </p>
    ...
    console.log("📧 Application Successful email sent successfully!");
    console.log("Message ID:", data.messageId);
    return data;
  } catch (error) {
    console.error("❌ Error sending Application Successful email:", error);
    return null;
  }
};

module.exports = applicationSuccessfulEmail;
