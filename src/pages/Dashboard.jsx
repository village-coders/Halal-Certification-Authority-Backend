...
//   const {products} = useProducts();
  ...
  const statsData = [
    ...
    { title: "PRODUCTS", count: 4, icon: "fa-cube", color: "#2196f3" },
  ...
  const quickActions = [
    ...
    { title: "ADD / REMOVE PRODUCT", icon: "fa-cubes", color: "#9c27b0", link: "products" }
  ];
                ...
                <div className="quick-actions">
                    ...
                    {quickActions.map((action, index) => (
                        ...
                        <div className="action-content">
                            <h3>{action.title}</h3>
                            <Link to={`/${action.link}`}  className="action-btn">Start</Link>
                        </div>
                        </div>
                    ))}
                    </div>
