...
const applicationSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ["Submitted", "Issued", "Renewal", "Rejected", "Accepted", "With Shari'a Board", "Successful"],
    default: 'Submitted'
  },
  requestedDate: {
    type: Date,
  ...
  processData: {
    ...
    audit: {
      ...
      ncCorrectionFile: { type: String, default: '' }, // client uploaded correction
    ...
    // Step 7: Application Successful
    certificationApprovedAt: { type: Date },
    // Step 8: Certificate Processing
